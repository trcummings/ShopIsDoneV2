...
public partial class AssetPlacerPlugin : ContextlessPlugin
{
	...
	protected override void _Init()
	{
		...
		_themeFont = EditorInterface.Singleton.GetBaseControl().GetThemeFont("main", "EditorFonts");
	...
	private void SetVisible(bool visible)
	{
		...
		if (visible)
		{
			...
			_planePlacementController = new PlanePlacementController();
			AddChild(_planePlacementController);
			_planePlacementController.Init(_assetPlacerUi.placementUi, _snapping, EditorInterface.Singleton, EditorInterface.Singleton.GetEditedSceneRoot());

			_surfacePlacementController = new SurfacePlacementController();
			AddChild(_surfacePlacementController);
            _surfacePlacementController.Init(_assetPlacerUi.placementUi, _snapping, EditorInterface.Singleton, EditorInterface.Singleton.GetEditedSceneRoot());

            _terrain3DPlacementController = new Terrain3DPlacementController();
			AddChild(_terrain3DPlacementController);
            _terrain3DPlacementController.Init(_assetPlacerUi.placementUi, _snapping, EditorInterface.Singleton, EditorInterface.Singleton.GetEditedSceneRoot());

            _dummyPlacementController = new DummyPlacementController();
			AddChild(_dummyPlacementController);
            _dummyPlacementController.Init(_assetPlacerUi.placementUi, _snapping, EditorInterface.Singleton, EditorInterface.Singleton.GetEditedSceneRoot());
